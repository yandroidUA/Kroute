...
android {
    namespace = "io.github.yanadroidua.kroute.navigation.arguments"
...
mavenPublishing {
    ...
    coordinates(artifactId = "navigation-arguments")
    pom {
        name = "Kroute Navigation Arguments"
        description = "A Kroute navigation arguments library."
        inceptionYear = "2025"
        url = pomUrl
        licenses {
            license {
