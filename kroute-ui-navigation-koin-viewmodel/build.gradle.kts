...
kotlin {
    ...
    sourceSets {
        commonMain.dependencies {
            ...
            implementation(projects.krouteUiKoinViewmodel)
...
android {
    namespace = "io.github.yanadroidua.kroute.ui.navigation.koin.viewmodel"
...
mavenPublishing {
    ...
    coordinates(artifactId = "ui-navigation-koin-viewmodel")
    pom {
        name = "Kroute Koin UI Navigation Koin Viewmodel"
        description = "An extension to the Kroute library to manage scoped Viewmodel in Composables tied to navigation lifecycle."
        inceptionYear = "2025"
        url = pomUrl
        licenses {
            license {
