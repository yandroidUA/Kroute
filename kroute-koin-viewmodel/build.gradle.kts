...
android {
    namespace = "io.github.yanadroidua.kroute.koin.viewmodel"
...
mavenPublishing {
    ...
    coordinates(artifactId = "koin-viewmodel")
    pom {
        name = "Kroute Koin Viewmodel"
        description = "An extension to the Kroute library to instantiate/provide Viewmodel instances via the Koin."
        inceptionYear = "2025"
        url = pomUrl
        licenses {
            license {
