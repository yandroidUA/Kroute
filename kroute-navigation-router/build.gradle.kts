...
kotlin {
    ...
    sourceSets {
        commonMain.dependencies {
            ...
            api(projects.kroute.krouteNavigationTransition)
...
android {
    namespace = "io.github.yanadroidua.kroute.navigation.router"
...
mavenPublishing {
    ...
    coordinates(artifactId = "navigation-router")
    pom {
        name = "Kroute Navigation Router"
        description = "A Kroute navigation router library."
        inceptionYear = "2025"
        url = pomUrl
        licenses {
            license {
