...
android {
    namespace = "io.github.yanadroidua.kroute.lifecycle.koin"
...
mavenPublishing {
    ...
    coordinates(artifactId = "lifecycle-koin")
    pom {
        name = "Kroute Lifecycle Koin"
        description = "An extension to the Kroute library to mange Koin's scopes on navigation."
        inceptionYear = "2025"
        url = pomUrl
        licenses {
            license {
