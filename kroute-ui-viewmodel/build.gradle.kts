...
android {
    namespace = "io.github.yanadroidua.kroute.ui.viewmodel"
...
mavenPublishing {
    ...
    coordinates(artifactId = "ui-viewmodel")
    pom {
        name = "Kroute Viewmodel UI"
        description = "An extension to the Kroute library to manage Viewmodels in Composables."
        inceptionYear = "2025"
        url = pomUrl
        licenses {
            license {
