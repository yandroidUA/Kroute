...
android {
    namespace = "io.github.yanadroidua.kroute.navigation.ui"
...
mavenPublishing {
    ...
    coordinates(artifactId = "navigation-ui")
    pom {
        name = "Kroute Navigation UI"
        description = "A Kroute navigation UI library."
        inceptionYear = "2025"
        url = pomUrl
        licenses {
            license {
