...
android {
    namespace = "io.github.yanadroidua.kroute.lifecycle.viewmodel"
...
mavenPublishing {
    ...
    coordinates(artifactId = "lifecycle-viewmodel")
    pom {
        name = "Kroute Lifecycle Viewmodel"
        description = "An extension to the Kroute library to manage Viewmodels on navigation."
        inceptionYear = "2025"
        url = pomUrl
        licenses {
            license {
