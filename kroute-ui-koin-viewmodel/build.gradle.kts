...
kotlin {
    ...
    sourceSets {
        commonMain.dependencies {
            ...
            implementation(projects.krouteLifecycleViewmodel)
            implementation(projects.krouteKoinViewmodel)
...
android {
    namespace = "io.github.yanadroidua.kroute.ui.koin.viewmodel"
...
mavenPublishing {
    ...
    coordinates(artifactId = "ui-koin-viewmodel")
    pom {
        name = "Kroute Koin Viewmodel UI"
        description = "An extension to the Kroute library to manage Viewmodel in Composables."
        inceptionYear = "2025"
        url = pomUrl
        licenses {
            license {
