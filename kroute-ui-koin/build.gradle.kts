...
kotlin {
    ...
    sourceSets {
        commonMain.dependencies {
            ...
            implementation(projects.krouteLifecycleKoin)
        }
    }
}

android {
    namespace = "io.github.yanadroidua.kroute.ui.koin"
...
mavenPublishing {
    ...
    coordinates(artifactId = "ui-koin")
    pom {
        name = "Kroute Koin UI"
        description = "An extension to the Kroute library to imanage Koin scopes in Composables."
        inceptionYear = "2025"
        url = pomUrl
        licenses {
            license {
