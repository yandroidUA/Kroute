...
android {
    namespace = "io.github.yanadroidua.kroute.lint.utils"
...
mavenPublishing {
    ...
    coordinates(artifactId = "lint-utils")
    pom {
        name = "Kroute Lint Utils"
        description = "An extension to the Kroute library to bypass some lint checkers"
        inceptionYear = "2025"
        url = pomUrl
        licenses {
            license {
